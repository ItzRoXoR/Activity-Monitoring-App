...
async function seed() {
    ...
    try {
        ...
        const workouts = [
            ...
            {
                title: "Chest Blast",
                type: "STRENGTH", difficulty: "MEDIUM", duration_minutes: 12, is_recommended: true,
                exercises: ["Push-ups", "Wide Push-ups", "Diamond Push-ups", "Chest Dips (bench)"],
            },
            {
                title: "Arm Toner",
                type: "STRENGTH", difficulty: "EASY", duration_minutes: 8, is_recommended: false,
                exercises: ["Bicep Curl (bodyweight)", "Tricep Dips", "Arm Circles"],
            },
            {
                title: "Leg Day",
                type: "STRENGTH", difficulty: "HARD", duration_minutes: 15, is_recommended: true,
                exercises: ["Squats", "Lunges", "Wall Sit", "Calf Raises", "Jump Squats"],
            },
            {
                title: "Back Strength",
                type: "STRENGTH", difficulty: "MEDIUM", duration_minutes: 10, is_recommended: false,
        ...
        for (const w of workouts) {
         ...
         VALUES ($1, $2, $3, $4, $5) RETURNING id`,
            ...
            for (let i = 0; i < w.exercises.length; i++) {
                ...
                if (!exId) {
                    console.warn(`  ⚠ Exercise "${w.exercises[i]}" not found in seed data`);
                    continue;
                }
                await client.query(
